...
export default class ViewModel {
  private animalItem = ko.observableArray(animal);
  private animalFilter = ko.observable('');
  private animalMatch = ko.observableArray(['']);
  private itemList: void;
  private searchBox: void;
